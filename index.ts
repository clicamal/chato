...
import startModuleAlias from './src/start-module-alias';

startModuleAlias();

import startServer from '@http-server/start-server';

startServer();

console.log(`
Chato  Copyright (C) 2021  Tarcísio J. Santana Rodrigues
